...
@section('scripts')
				...
				columns: [{
					...
					},
					{
						...
						render: function(data, type, row) {
							...
							return '<span class="text-danger fw-semibold">-Rp ' + parseInt(data)
	...
	<script>
		window.addEventListener('close-modal', () => {
			...
			let modalInTransferEl = document.getElementById('internalTransferModal');
			let modal = bootstrap.Modal.getInstance(modalEl) || new bootstrap.Modal(modalEl);
			modal.hide();

			let modalInTransfer = bootstrap.Modal.getInstance(modalInTransferEl) || new bootstrap.Modal(
				modalInTransferEl);
			modalInTransfer.hide();
